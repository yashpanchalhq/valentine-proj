...
export const metadata = {
  title: "Valentine's Day 💕 | For Anu Rawat",
  description: "Happy Valentine's Day, Anu! This day is all about celebrating YOU!",
};
...
export default function ValentinesDay() {
  return (
    <DayPage
      ...
      date="February 14th"
      message="Happy Valentine's Day, Anu Rawat! 💕 You are my everything - my best friend, my inspiration, my reason to smile every single day. Thank you for being the most amazing person I've ever known. I'm so lucky to have you in my life!"
      poem={[
        "Anu, today we celebrate our story,",
        ...
        "Happy Valentine's Day, Anu, in every way! 💝",
      ]}
